...
const _addOtherUsedVersions = curry(function(moduleByNameByVersion, module) {
...
export default curry(function(licenseWhitelist, exceptionWhitelist, moduleWhitelist, moduleMap) {
