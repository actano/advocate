...
describe('license whitelist check', () => {
  ...
  describe('simple license name', () => {
    context('well known license', () => {
      ...
      it('should return false if name isn\'t whitelisted', () => expect(isLicenseWhitelisted('JSON')).to.be.false)
    })
    ...
    context('random license name', () => {
      ...
      context('non alpha numeric license name', () => {
        ...
        it('should return true if non alphanumeric name is whitelisted', () => expect(isLicenseWhitelisted('($?!')).to.be.true)
      })
    })
  })
  ...
  describe('array of simple license names', () => {
    ...
    it('should return false if the array is empty', () => expect(isLicenseWhitelisted([])).to.be.false)
  })
  ...
  describe('SPDX license expression', () => {
    ...
    describe('with exceptions', () => {
      ...
      it('should return false if expression isn\'t using a whitelisted exception', () => expect(isLicenseWhitelisted('MIT WITH Libtool-exception')).to.be.false)
    })
  })
})
